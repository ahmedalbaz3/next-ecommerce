...
This is a modern, scalable **Next.js e-commerce application** built with a strong focus on **performance, maintainability, internationalization, and clean architecture**.

The application provides a smooth shopping experience where users can browse products, view product details, manage carts and wishlists, and complete checkout flows through a fast, accessible, and SEO-optimized interface.

The project is **production-ready**, easy to extend, and fully optimized for **desktop and mobile devices**.
